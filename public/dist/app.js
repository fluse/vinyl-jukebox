...
},{"../lib/dom":5,"../lib/helper":8,"./instances":20,"./update-geometry":21,"./update-scroll":22}],24:[function(require,module,exports){
...
module.exports = function (eventList) {
    ...
    return {
        ...
        isGamePadConnected: function isGamePadConnected() {
        ...
        checkAxesIsInUse: function checkAxesIsInUse() {
...
},{"./mapping.js":75}],74:[function(require,module,exports){
'use strict';
...
},{"./core.js":73,"extend":1}],75:[function(require,module,exports){
'use strict';
...
module.exports = {
    ...
    methods: {
        _scrollToSelectedCover: function _scrollToSelectedCover() {
    ...
    return new Vue({
        ...
        ready: function ready() {
            ...
            this.socket.on('getPlaylist', function (currentPlaylist) {
                ...
                _this.playlist.current = currentPlaylist;
                Vue.nextTick(function () {
